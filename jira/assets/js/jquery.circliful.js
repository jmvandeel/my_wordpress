	...
	$.fn.circliful = function (options, callback) {
		...
		return this.each(function () {
			...
			if (settings.targetPercent > 0) {
				...
				elements += '<circle cx="100" cy="100" r="69" fill="none" stroke="' + settings.targetColor + '" stroke-width="3" stroke-dasharray="' + (437 / 100 * settings.targetPercent) + ', 20000" transform="rotate(-90,100,100)" />';
			}
